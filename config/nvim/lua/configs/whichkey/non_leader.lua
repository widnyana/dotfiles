return {
    ...
    n = {
        name = "UI",
        c = { "<cmd>lua require('configs.utils').toggle_set_color_column()<CR>", "Toggle Color Line" },
        l = { "<cmd>lua require('configs.utils').toggle_cursor_line()<CR>", "Toggle Cursor Line" },
        b = { "<cmd>lua require('configs.utils').change_background()<CR>", "Toggle Background" },
    },
    b = {
    ...
    g = {
        ...
        h = { "<cmd>lua require('configs.utils').toggle_inlay_hints()<CR>", "Toggle Inlay Hints" },
