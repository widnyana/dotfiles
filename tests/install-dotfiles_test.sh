...
assert_symlink_to "$(cfg hypr)"    "$FIXTURE/config/hypr"    "hyprland linked on Linux"
assert_symlink_to "$(cfg fluxbox)" "$FIXTURE/config/fluxbox" "fluxbox linked on Linux"
...
assert_absent "hyprland NOT linked on macOS" "$(cfg hypr)"
assert_absent "fluxbox NOT linked on macOS"  "$(cfg fluxbox)"
